...
var orderItems = [];        // Массив для хранения позиций стандартного калькулятора
var currentItem = null;     // Текущая позиция стандартного калькулятора

var tenderItems = [];       // Массив для хранения позиций тендерного калькулятора  
var currentTenderItem = null; // Текущая позиция тендерного калькулятора
