...
// Версия: 9.3 (17.02.2026) - ИСПРАВЛЕННАЯ (хлебные крошки)
// ============================================
(function() {
    'use strict';
    
    console.log('🔄 Загружаем хедер v9.3...');
...
<head>
    ...
    <link rel="stylesheet" href="/css/mobile.css?v=9.3" media="(max-width: 768px)">
...
`;
    ...
    console.log('✅ Хедер v9.3 успешно загружен');
